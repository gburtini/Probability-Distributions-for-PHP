<?php
	 ...
	 *
	 * Copyright (C) 2017 Giuseppe Burtini <joe@iterative.ca> except where otherwise noted.
	 *
	 */
	...
	class GBPDP_Weibull extends GBPDP_Distribution {
		...
		public function mean() {
			return $this->lambda * exp(GBPDP_GammaFunction::logGammaFunction(1.0 + 1.0/$this->k));
		}

		public function variance() {
			return $this->lambda * $this->lambda * (
					exp(GBPDP_GammaFunction::logGammaFunction(1.0 + 2.0/$this->k))  -
					pow(exp(GBPDP_GammaFunction::logGammaFunction(1.0 + 1.0/$this->k)), 2)
				);
		}
