...
class IncompleteGammaFunction
{
    ...
    */
    ...
    public static $MACHEP = 1.11022302462515654042E-16;
    public static $MAXLOG = 7.08396418532264106224E2;
    ...
    */
    ...
    public static function inverseComplementedIncompleteGamma($a, $y0)
    {
        ...
        $lgm = GammaFunction::logGammaFunction($a);
    ...
    */
    ...
    /* sqrt(2pi) */
    public static $s2pi = 2.50662827463100050242E0;
    ...
    */
    ...
    public static function inverseNormal($y0)
    {
        ...
        if ($x < 8.0) {
            $x1 = $z * static::polevl($z, static::$P1) / static::polevl($z, static::$Q1);
        } else {
            $x1 = $z * static::polevl($z, static::$P2) / static::polevl($z, static::$Q2);
        }
