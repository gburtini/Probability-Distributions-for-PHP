...
class TDistributionTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testTInvalidInstantiation()
    {
        $this->setExpectedException('InvalidArgumentException');
        $invalid = new T(0);
    }

    public function testTInvalidInstantiation2()
    {
        $this->setExpectedException('InvalidArgumentException');
        $invalid = new T(-1);
    }

    public function testTInvalidInstantiation3()
    {
        $this->setExpectedException('InvalidArgumentException');
        $invalid = new T("a");
    }

    public function testTPDF()
    {
        $d = new T(6);
    ...
    public function testTPDFSpecialCases()
    {
        $accuracy = 1e-10;
    ...
    public function testTCDFSpecialCases()
    {
        $accuracy = 1e-10;
